...
━━━━━━━━━━━━━━━━━━━━━━━━
[제목 5개 생성 규칙 — 가장 중요]
1. **앞 30자 이내에 검색 키워드 배치**: 시청자가 검색할 핵심 단어를 제목 앞부분에 먼저
   예) "무릎 통증 없애는 방법 3가지" / "피부 미백 실화? 이거 하나로"
2. **15~20자 이내 간결한 문장** (최대 25자 초과 금지)
3. **숫자 활용**: 구체적 숫자·기간·순위로 신뢰도·CTR 상승
   예) "3일 만에 효과", "1위 성분", "98% 만족"
4. **호기심 자극 문구**: 괄호·물음표·반전으로 클릭 유도
   예) "(충격)", "이게 맞아?", "왜 아무도 안 알려줬지"
5. **[상품/컨텍스트 정보]의 핵심 키워드·제품명 반드시 반영**
6. 유형별로 각각 다르게: 검색형·호기심형·숫자형·후기형·반전형
7. 댓글 반응·상품 특징·대본 핵심 내용을 제목에 녹일 것
